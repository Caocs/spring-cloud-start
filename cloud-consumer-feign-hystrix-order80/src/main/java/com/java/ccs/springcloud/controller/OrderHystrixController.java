...
/**
 * @Author: Cao.cs
 * @Date: Created in 20:55 2022/3/23
 * @DefaultProperties(defaultFallback = "payment_Global_FallbackMethod")：hystrix全局fallback方法，当类中方法设置
 */
@RestController
@Slf4j
...
public class OrderHystrixController {
    ...
    /**
     * @HystrixCommand: 执行全局服务降级fallback方法 (需要添加@DefaultProperties注解)
     * @HystrixCommand(fallbackMethod = "paymentTimeOutFallbackMethod"...): 会执行对应的降级方法。
     */
